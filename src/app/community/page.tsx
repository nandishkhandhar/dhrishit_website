      ...
      <div className="container mx-auto px-6 py-20">
        <div className="max-w-4xl mx-auto">
          ...
          <div className="space-y-12">
            ...
            {/* GreytoGrow */}
            <div className="bg-gradient-to-br from-white via-teal-50/30 to-white dark:from-gray-800/70 dark:via-teal-900/10 dark:to-gray-800/70 backdrop-blur-sm rounded-2xl shadow-xl border border-teal-200/60 dark:border-teal-800/40 hover:shadow-2xl transition-all duration-300 p-8">
              <div className="flex items-center gap-4 mb-6">
                ...
                <div>
                  <h3 className="text-2xl font-bold bg-gradient-to-r from-teal-700 to-emerald-600 dark:from-teal-300 dark:to-emerald-300 bg-clip-text text-transparent mb-1">Project GreytoGrow</h3>
                  <p className="text-teal-600 dark:text-teal-400 font-medium">Founder • <span className="font-bold">🏆 Earth Prize Asian Scholar Award Winner</span> • 2025</p>
                </div>
              </div>

              <div className="bg-gradient-to-r from-teal-50/50 via-emerald-50/50 to-cyan-50/50 dark:from-teal-900/10 dark:via-emerald-900/10 dark:to-cyan-900/10 rounded-xl p-6 border-l-4 border-teal-500 mb-6">
                <p className="text-gray-800 dark:text-gray-200 leading-relaxed text-base">
                  Created a
            ...
            <div className="bg-gradient-to-br from-white via-cyan-50/30 to-white dark:from-gray-800/70 dark:via-cyan-900/10 dark:to-gray-800/70 backdrop-blur-sm rounded-2xl shadow-xl border border-cyan-200/60 dark:border-cyan-800/40 hover:shadow-2xl transition-all duration-300 p-8">
              <div className="flex items-center gap-4 mb-6">
                <div className="w-16 h-16 rounded-lg flex items-center justify-center flex-shrink-0 overflow-hidden">
                  <Image src="/saakshartalogo.jpg" alt="Saaksharta Foundation Logo" width={64} height={64} className="w-16 h-16 object-contain" />
                </div>
                <div>
                  <h3 className="text-2xl font-bold bg-gradient-to-r from-cyan-700 to-blue-600 dark:from-cyan-300 dark:to-blue-300 bg-clip-text text-transparent">Teaching Volunteer</h3>
                  <p className="text-cyan-600 dark:text-cyan-400 font-medium">Saaksharta Foundation</p>
                </div>
              </div>
