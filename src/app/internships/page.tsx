      ...
      <div className="container mx-auto px-6 py-20">
        <div className="max-w-4xl mx-auto">
          ...
          <div className="space-y-12">
            ...
            {/* MiBiome - 2025 */}
            <div className="bg-gradient-to-br from-white via-purple-50/30 to-white dark:from-gray-800/70 dark:via-purple-900/10 dark:to-gray-800/70 backdrop-blur-sm rounded-2xl shadow-xl border border-purple-200/60 dark:border-purple-800/40 hover:shadow-2xl transition-all duration-300">
              <button
                onClick={() => setMiBiomeOpen(!miBiomeOpen)}
                className="w-full flex items-center justify-between gap-4 p-6 group hover:bg-gradient-to-r hover:from-purple-50/80 hover:to-purple-100/40 dark:hover:from-purple-900/30 dark:hover:to-purple-800/20 rounded-2xl transition-all duration-300 transform hover:scale-[1.01]"
              >
                <div className="flex flex-col items-start gap-2 flex-1">
                  <div className="flex items-center gap-3">
                    <div className="w-12 h-12 rounded-lg flex items-center justify-center flex-shrink-0 overflow-hidden">
                    ...
                    <h2 className="text-xl font-bold bg-gradient-to-r from-purple-700 to-violet-600 dark:from-purple-300 dark:to-violet-300 bg-clip-text text-transparent text-left">
                      MiBiome Lab Mumbai: Genomics Research
                    </h2>
                  </div>
                  <div className="ml-15 flex flex-wrap gap-2">
                    <span className="bg-purple-100 dark:bg-purple-900/30 text-purple-800 dark:text-purple-200 px-2 py-1 rounded text-sm">Research Assistant</span>
                    <span className="bg-violet-100 dark:bg-violet-900/30 text-violet-800 dark:text-violet-200 px-2 py-1 rounded text-sm">Summer 2025</span>
                  </div>
                </div>
                <div className={`transform transition-all duration-300 ${miBiomeOpen ? 'rotate-180' : ''} group-hover:scale-110`}>
                  <div className="w-10 h-10 bg-gradient-to-br from-purple-100 to-violet-200 dark:from-purple-800/60 dark:to-violet-700/40 rounded-full flex items-center justify-center shadow-md">
              ...
              {miBiomeOpen && (
                <>
                  <div className="w-full h-px bg-gradient-to-r from-purple-200 via-violet-400 to-purple-200 dark:from-purple-800 dark:via-violet-600 dark:to-purple-800 mb-8"></div>

                  <div className="space-y-6 px-6 pb-6">
                    <div className="bg-gradient-to-r from-purple-50/50 via-violet-50/50 to-fuchsia-50/50 dark:from-purple-900/10 dark:via-violet-900/10 dark:to-fuchsia-900/10 rounded-xl p-6 border-l-4 border-purple-500">
                      <p className="text-gray-800 dark:text-gray-200 leading-relaxed text-base">
                        <span className="font-semibold text-purple-700 dark:text-purple-400">MiBiome</span> develops cutting-edge genomics technologies to democratize genetic research and advance precision medicine.
                        Gained expertise in
                        <span className="font-semibold text-purple-700 dark:text-purple-400"> DNA sequencing methodologies</span> including
                        <span className="font-semibold text-purple-700 dark:text-purple-400"> Sanger sequencing</span> and next-generation
                        <span className="font-semibold text-purple-700 dark:text-purple-400"> Illumina sequencing techniques</span>.
                      </p>
                    </div>
                    ...
                    <div className="grid md:grid-cols-3 gap-4">
                      <div className="bg-gradient-to-br from-purple-50 to-violet-50 dark:from-purple-900/20 dark:to-violet-900/20 rounded-xl p-4 border border-purple-200/50 dark:border-purple-700/30">
                        <p className="text-xs text-purple-600 dark:text-purple-400 uppercase tracking-wide mb-1">Focus Area</p>
                        <p className="text-sm font-bold text-gray-800 dark:text-gray-200">Microbiome Research</p>
                      </div>
                      <div className="bg-gradient-to-br from-violet-50 to-fuchsia-50 dark:from-violet-900/20 dark:to-fuchsia-900/20 rounded-xl p-4 border border-violet-200/50 dark:border-violet-700/30">
                        <p className="text-xs text-violet-600 dark:text-violet-400 uppercase tracking-wide mb-1">Specialty</p>
                        <p className="text-sm font-bold text-gray-800 dark:text-gray-200">Bioinformatics</p>
                      </div>
                      <div className="bg-gradient-to-br from-fuchsia-50 to-pink-50 dark:from-fuchsia-900/20 dark:to-pink-900/20 rounded-xl p-4 border border-fuchsia-200/50 dark:border-fuchsia-700/30">
                        <p className="text-xs text-fuchsia-600 dark:text-fuchsia-400 uppercase tracking-wide mb-1">Research Type</p>
